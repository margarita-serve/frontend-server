<template>
    <div class="layout-container flex flex-column">
        ...
        <div class="layout-main flex flex-row">
            <!-- <K3SidebarMenu v-model:collapsed="collapsed" :menu="menus" :show-one-child="true"
                @update:collapsed="onToggleCollapsed" @item-click="onItemClicked" /> -->
            <div class="page-scroller flex-grow-1">
                <div class="page-container w-full">
                    <slot />
                </div>
                <K3ScrollTop target="parent" :threshold="100" />
            </div>
        </div>
        <!-- <Footer /> -->
    </div>
