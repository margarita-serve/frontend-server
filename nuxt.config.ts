...
export default defineNuxtConfig({
  ...
  srcDir: "src/",
  // Stylesheets
  css: ["@fortawesome/fontawesome-free/css/all.css", "primevue/resources/themes/bootstrap4-light-blue/theme.css", "primevue/resources/primevue.css", "primeicons/primeicons.css", "primeflex/primeflex.css", "prismjs/themes/prism-coy.css", "~/assets/scss/layout.scss", "~/assets/scss/app.scss"],
